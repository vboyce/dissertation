...
### study 1
rotate_data_loc <- "mpt/data/study1"
...
no_rotate_data_loc <- "mpt/data/study2a"
...
feedback_data_loc <- "mpt/data/study2b"
...
### study 2c
data_location_2c <- "mpt/data/study2c"
...
data_location_3 <- "mpt/data/study3"
