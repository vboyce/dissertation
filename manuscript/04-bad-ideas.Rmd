...
Additionally, we were interested in how quickly naive matchers process the linguistic descriptions and how this might relate to the oredictability and informativity of the descriptions. Word predictability (often measured as surprisal) is a predictor of language processing times. The iterated reference game transcripts present an interesting test case because expressions are likely to be globall uncommon (and thus unpredictable), but may be licenced and unsurprising given the immediate visual context and conversation history. Thus, another question of interest is how rapidly comprehenders are able to adapt to the changing context. 
